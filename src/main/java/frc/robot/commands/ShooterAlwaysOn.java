...
public class ShooterAlwaysOn extends Command {
  private Shooter shooter;
  private Targeting targeting;
  /** Creates a new FireNote. */
  public ShooterAlwaysOn(Shooter shooter , Targeting targeting) {
  ...
  public void newShooter(){
    if(targeting.getValidTarget() == 0 || targeting.calcRange() > 91){
       shooter.fireNote(4700 , 900);//range 77.08
    }
    else{
